...
#define CONST_STRING_DEF_INVALID_ASSOC(Ty, sl)                                 \
    Ty * : &sl, Ty const * : &sl, Ty restrict * : &sl, Ty const restrict * : &sl
...
#define STRING(sl)                                                             \
    _Generic((sl),                                                             \
        ...
        const char16_t *: CONST_STRING_DEF_ASSOC_TYPE(u16string_t, char16_t,   \
                                                      sl),                     \
        char32_t *: CONST_STRING_DEF_ASSOC_TYPE(u32string_t, char32_t, sl),    \
        const char32_t *: CONST_STRING_DEF_ASSOC_TYPE(u32string_t, char32_t,   \
                                                      sl),                     \
        wchar_t *: CONST_STRING_DEF_ASSOC_TYPE(u32string_t, char32_t, sl),     \
        const wchar_t *: CONST_STRING_DEF_ASSOC_TYPE(u32string_t, char32_t,    \
                                                     sl))

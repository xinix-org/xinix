...
#else
    return (_x >> 24) | ((_x >> 16) & 0_xFF00) | ((_x << 16) & 0_xFF0000) |
           (_x << 24);
#endif
}
...
static inline unsigned char stdx_swap_bytes_uc(unsigned char _x) { return _x; }
...
#define _STDBIT_DEF_DO_IDENT_FN(name, ty, suffix)                              \
    static inline ty name##_##suffix(ty _val) { return _val; }
